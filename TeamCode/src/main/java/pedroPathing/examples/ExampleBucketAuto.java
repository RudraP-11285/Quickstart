...
public class ExampleBucketAuto extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(32.5, 120, Math.toRadians(0));

    /** Middle (Second) Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(32.5, 131, Math.toRadians(0));

    /** Highest (Third) Sample from the Spike Mark */
    private final Pose pickup3Pose = new Pose(45, 135, Math.toRadians(90));
