...
public class sampleAutoV2 extends OpMode {
    ...
    public void init() {
        ...
        limelight.pipelineSwitch(chosenPipeline);
        limelight.start();
    ...
    public void init_loop() {
        ...
        telemetry.addData("Pipeline Chosen", chosenPipeline);

        switch (chosenPipeline) {
            case 0:
                telemetry.addData("Pipeline:", "Competition Field");
                break;
            case 1:
                telemetry.addData("Pipeline:", "Practice Field");
                break;
            case 2:
                telemetry.addData("Pipeline:", "EMPTY: DO NOT RUN");
                break;
            case 3:
                telemetry.addData("Pipeline:", "EMPTY: DO NOT RUN");
                break;
